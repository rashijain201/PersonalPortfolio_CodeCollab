export default {
    ...
    about: {
        heading: "About Me",
        description:
            "Write a short introduction about yourself, your interests and skills.",
    },
    projectsPage: {
        heading: "Project Highlights",
        description:
            "Showcase 3–5 of your best projects with links and short descriptions.",
        grid: [
            {
                title: "Project 1",
                description:
    ...
    contact: {
        ...
        description:
            "Provide your preferred contact details or a form link for visitors.",
    },
};
